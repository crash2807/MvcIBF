...
namespace MvcIBF.Controllers
{
    ...
    {
        private readonly MvcIBFContext _context;

        public MoviesController(MvcIBFContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieId,MovieTitle,ReleaseDate,Runtime,MovieDescription")] Movie movie)
        {
            if (id != movie.MovieId)
            {
                return NotFound();
